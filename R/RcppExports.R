...
#' @keywords internal
dependentLCM_fit_cpp <- function(x_in, hparams_list, params_list) {
    .Call(`_dependentLCM_dependentLCM_fit_cpp`, x_in, hparams_list, params_list)
}
...
#' @export
get_pattern2id_map <- function(item_nlevels, items, items_addend = -1L) {
    .Call(`_dependentLCM_get_pattern2id_map`, item_nlevels, items, items_addend)
}
