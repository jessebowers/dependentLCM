...
public:
  ...
  domainProposalOut domain_proposal(int class2domain_id, Hyperparameter& hparams, int maxitr=5);
...
//' @keywords internal
domainProposalOut BayesParameter::domain_proposal(int class2domain_id, Hyperparameter& hparams, int maxitr) {
